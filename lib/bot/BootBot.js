...
class BootBot extends EventEmitter {
    ...
    sendBoardingPass(recipientId, boardingPass, options) {
        const payload = {
            ...
            intro_message : "You have checked-in. Here is you ticket and hope you have a happy flight ^_^"
        };
        if(boardingPass)
    ...
    sendCheckinReminder(recipientId, bookingNumber, flightInfo, checkinUrl, options) {
        const payload = {
            ...
            intro_message : "Check-in is open now: go ahead and get your boarding pass! See you soon ^_^",
            theme_color   : "#0084ff"
        };
        if(bookingNumber)
    ...
    sendFlightUpdate(recipientId, updateType, bookingNumber, updateFlightInfo, options) {
        const payload = {
            ...
            "intro_message": "Dear passenger, we are very sorry, your flight is delayed. Here is the new info ^_^",
