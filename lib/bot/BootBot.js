...
class BootBot extends EventEmitter {
    constructor(options) {
        ...
        this.wit = [];
        // Our bot actions
        this.actions = require('./wit/actions')(this, sessions);
    ...
    _handleMessageEvent(event) {
        ...
        this._hearMap.every(hear => {
            if (typeof hear.keyword === 'string' && hear.keyword.toLowerCase() === text.toLowerCase()) {
                ...
                const sessionId = this._findOrCreateSession(event.sender.id);
                ...
                if(attachments){
                    ...
                    this.wit.runActions(sessionId, text, sessions[sessionId].context).then((context) => {
